...
!function () {
    ...
    var d = document.querySelector("#visitorsChart"), c = {
        ...
        series: [{data: [587, 312, 723, 149, 501, 857, 246]}],
        dataLabels: {enabled: !1},
        ...
        xaxis: {
            categories: ['24.03', '25.03', '26.03', '27.03', '28.03', '29.03', '30.03'],
        ...
        xaxis: {
            categories: ["Янв", "Фев", "Mar", "Apr", "May", "Jun"],
        ...
        xaxis: {
            show: !1,
            categories: ["Янв", "Фев", "Mar", "Apr", "May", "Jun", "Jul"],
            labels: {show: !1},
            axisTicks: {show: !1},
            axisBorder: {show: !1}
        },
